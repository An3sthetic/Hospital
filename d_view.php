...
$query = "SELECT doctor_info.dName, department.name FROM doctor_info, department WHERE doctor_info.department = department.Dep_id AND doctor_info.Essn like '%$term%'";
